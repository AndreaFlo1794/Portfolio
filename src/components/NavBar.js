  ...
  return (
    ...
    >
      ...
      <nav className='flex items-center justify-center flex-wrap'>
        <motion.a href='https://www.instagram.com/andfloc17/?hl=en' target={'_blank'}
          whileHover={{ y: -2 }}
          whileTap={{ scale: 0.9 }}
          className='w-6 mx-3'>
          <InstagramIcon />
        </motion.a>
        <motion.a href='https://github.com/AndreaFlo1794' target={'_blank'}
          className='w-6 mx-3'
          whileHover={{ y: -2 }}
          whileTap={{ scale: 0.9 }}
        >
        ...
        <motion.a href='https://www.linkedin.com/in/mafloc/' target={'_blank'}
          className='w-6 mx-3'
          whileHover={{ y: -2 }}
          whileTap={{ scale: 0.9 }}>
          <LinkedInIcon />
