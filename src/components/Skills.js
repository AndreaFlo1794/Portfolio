...
const Skills = () => {
    return (
        <>
            ...
            lg:bg-circularLightMd lg:dark:bg-circularDarkMd
            lg:bg-circularLightSm lg:dark:bg-circularDarkSm'>
